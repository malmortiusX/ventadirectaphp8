        ...
        <div class="container-full">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h1 class="title">Pedido Semanal Pollo</h1>
                ...
                <div class="col s12">
                    <div class="card highlighted">
                        <div class="card-content center">
                            <span class="card-title highlighted center mb-1 uppercase">Gracias Por Diligenciar el Pedido Semanal de Pollo</span>
                            @if ($limite->format('Y-m-d') == date('Y-m-d'))
                                <span class="card-subtitle subtitle-2 highlighted mb-0">Recuerde que debe ser finalizado hoy antes de las 12:00 m.</span>
                            @else
                                <span class="card-subtitle subtitle-2 highlighted mb-0">Recuerde que debe ser finalizado antes del {{ $limite->formatLocalized("%A %d de %B del %Y") }} a las 12:00 m.</span>
                            @endif
                        </div>
                    </div>
                </div>
