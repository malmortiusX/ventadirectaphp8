...
<body>
    <main class="main-content container-full" id="main-content" style="max-width: inherit;">
        <section class="div-main">
            <form action="{{ route('clientes.externos.store.cop') }}" method="POST" id="form">
                @csrf
                ...
                <input type="hidden" class="hide" name="cop" id="cop" value="{{ isset($pdv) ? $pdv->cop : '' }}">
                <input type="hidden" class="hide" name="campana" id="campana" value="{{ isset($campanaActiva) ? $campanaActiva->nombre : '' }}">
                <div class="container">
                    <div class="row">
                        <div class="col s12 m6">
                            <h1 class="title">{{ isset($cliente) ? "Actualiza" : "Nuevo" }} Cliente {{ ucwords(strtolower($centroDistribucion->nombre)) }}</h1>
                            <div class="breadcrumbs full-width">
                                <a class="breadcrumb">{{ isset($cliente) ? "Actualiza" : "Nuevo" }} Cliente</a>
                            </div>
                        </div>
                        <div class="col m6 right-align hide-on-small-only">
                            <button class="mdc-button mdc-button--raised mdc-button--large crear_cliente" type="submit">
                                <span class="mdc-button__label mr-1">{{ isset($cliente) ? "Actualizar" : "Crear" }} Cliente</span>
                                    ...
                                    <div class="row mb-0">
                                        <div class="col s12 m6 l4 mb-1">
                                            <label class="mdc-text-field mdc-text-field--outlined mdc-text-field--dense" id="mdc-nombres">
                                                <input type="text" class="mdc-text-field__input uppercase" aria-labelledby="lbl_nombres" name="nombres" id="nombres" required maxlength="30" value="{{ isset($cliente) ? $cliente->nombre_cliente : "" }}">
                                                <span class="mdc-notched-outline">
                                                    <span class="mdc-notched-outline__leading"></span>
                                                    <span class="mdc-notched-outline__notch">
                                                        <span class="mdc-floating-label" id="lbl_nombres">Nombre Completo</span>
                                                    </span>
                                        ...
                                        <div class="col s12 m6 l4 mb-1">
                                            <div class="mdc-select mdc-select--outlined mdc-select--dense mdc-select--required focusable" id="mdc-select__tipo_documento">
                                                <div class="mdc-select__anchor" aria-required="true" aria-labelledby="tipo_documento-select-label">
                                                    <input type="text" name="tipo_documento" id="tipo_documento" class="mdc-select__input-value" value="{{ isset($cliente) ? $cliente->tipo_documento : "" }}">
                                                ...
                                                <div class="mdc-select__menu mdc-menu mdc-menu-surface mdc-menu--dense" role="listbox">
                                                    <ul class="mdc-list">
                                                        <li class="mdc-list-item {{ (isset($cliente) && $cliente->tipo_documento == "CC") ?  "mdc-list-item--selected" : "" }}" data-value="CC" role="option">
                                                            <span class="mdc-list-item__ripple"></span>
                                                            <span class="mdc-list-item__text">CC</span>
                                                        </li>
                                                        <li class="mdc-list-item {{ (isset($cliente) && $cliente->tipo_documento == "CE") ?  "mdc-list-item--selected" : "" }}" data-value="CE" role="option">
                                                            <span class="mdc-list-item__ripple"></span>
                                                            <span class="mdc-list-item__text">CE</span>
                                                        </li>
                                                        <li class="mdc-list-item {{ (isset($cliente) && $cliente->tipo_documento == "PEP") ?  "mdc-list-item--selected" : "" }}" data-value="PEP" role="option">
                                                            <span class="mdc-list-item__ripple"></span>
                                        ...
                                        <div class="col s12 m6 l4 mb-1">
                                            <label class="mdc-text-field mdc-text-field--outlined mdc-text-field--dense" id="mdc-codigo_cli">
                                                <input type="text" class="mdc-text-field__input uppercase" aria-labelledby="lbl_codigo_cli" name="codigo_cli" id="codigo_cli" required maxlength="30" value="{{ isset($cliente) ? $cliente->cedula : "" }}">
                                                <span class="mdc-notched-outline">
                                                    <span class="mdc-notched-outline__leading"></span>
                                                    <span class="mdc-notched-outline__notch">
                                        ...
                                        <div class="col s12 m6 l4 mb-0 mb-1">
                                            <label class="mdc-text-field mdc-text-field--outlined mdc-text-field--dense" id="mdc-telefono">
                                                <input type="number" class="mdc-text-field__input uppercase" aria-labelledby="lbl_telefono" name="telefono" id="telefono" required maxlength="10" value="{{ isset($cliente) ? $cliente->telefono : "" }}">
                                                <span class="mdc-notched-outline">
                                                    <span class="mdc-notched-outline__leading"></span>
                                                    <span class="mdc-notched-outline__notch">
                                        ...
                                        <div class="col s12 m6 l4 mb-1">
                                            <div class="mdc-select mdc-select--outlined mdc-select--dense focusable" id="mdc-select__genero">
                                                <div class="mdc-select__anchor" aria-labelledby="genero-select-label">
                                                    <input type="text" name="genero" id="genero" class="mdc-select__input-value" value="{{ isset($cliente) ? $cliente->genero : "" }}">
                                                ...
                                                <div class="mdc-select__menu mdc-menu mdc-menu-surface mdc-menu--dense" role="listbox">
                                                    <ul class="mdc-list">
                                                        <li class="mdc-list-item {{ (isset($cliente) && $cliente->genero == "M") ?  "mdc-list-item--selected" : "" }}" data-value="M" role="option">
                                                            <span class="mdc-list-item__ripple"></span>
                                                            <span class="mdc-list-item__text">M</span>
                                                        </li>
                                                        <li class="mdc-list-item {{ (isset($cliente) && $cliente->genero == "F") ?  "mdc-list-item--selected" : "" }}" data-value="F" role="option">
                                                            <span class="mdc-list-item__ripple"></span>
                                        ...
                                        <div class="col s12 m6 l4 mb-0 mb-1">
                                            <label class="mdc-text-field mdc-text-field--outlined mdc-text-field--dense" id="mdc-fecha_nacimiento">
                                                <input type="date" class="mdc-text-field__input uppercase" aria-labelledby="lbl_fecha_nacimiento" name="fecha_nacimiento" id="fecha_nacimiento" required maxlength="10" value="{{ isset($cliente) ? $cliente->fecha_nacimiento : "" }}">
                                                <span class="mdc-notched-outline">
                                                    <span class="mdc-notched-outline__leading"></span>
                                                    <span class="mdc-notched-outline__notch">
                                        ...
                                        <div class="col s12 m6 l4 mb-1">
                                            <label class="mdc-text-field mdc-text-field--outlined mdc-text-field--dense" id="mdc-direccion">
                                                <input type="text" class="mdc-text-field__input uppercase" aria-labelledby="lbl_direccion" name="direccion" id="direccion" required maxlength="90" value="{{ isset($cliente) ? $cliente->direccion : "" }}">
                                                <span class="mdc-notched-outline">
                                                    <span class="mdc-notched-outline__leading"></span>
                                                    <span class="mdc-notched-outline__notch">
                                        ...
                                        <div class="col s12 m6 l4 mb-1">
                                            <label class="mdc-text-field mdc-text-field--outlined mdc-text-field--dense" id="mdc-barrio">
                                                <input type="text" class="mdc-text-field__input uppercase" aria-labelledby="lbl_barrio" name="barrio" id="barrio" required maxlength="30" value="{{ isset($cliente) ? $cliente->barrio : "" }}">
                                                <span class="mdc-notched-outline">
                                                    <span class="mdc-notched-outline__leading"></span>
                                                    <span class="mdc-notched-outline__notch">
                                        ...
                                        <div class="col s12 m6 l4 mb-1">
                                            <label class="mdc-text-field mdc-text-field--outlined mdc-text-field--dense" id="mdc-correo">
                                                <input type="text" class="mdc-text-field__input uppercase" aria-labelledby="lbl_correo" name="correo" id="correo" required maxlength="100" value="{{ isset($cliente) ? $cliente->correo : "" }}">
                                                <span class="mdc-notched-outline">
                                                    <span class="mdc-notched-outline__leading"></span>
                                                    <span class="mdc-notched-outline__notch">
                                        ...
                                        <div class="col s12 m6 l4 mb-1">
                                            <label class="mdc-text-field mdc-text-field--outlined mdc-text-field--dense mdc-text-field--with-trailing-icon" id="mdc-pdv">
                                                <span class="mdc-notched-outline">
                                                    <span class="mdc-notched-outline__leading"></span>
                                                    <span class="mdc-notched-outline__notch">
                                                        <span class="mdc-floating-label" id="lbl_pdv">Punto más cercano</span>
                                                    </span>
                                                    <span class="mdc-notched-outline__trailing"></span>
                                                </span>
                                                <input type="text" class="mdc-text-field__input" data-input="pdv" aria-labelledby="lbl_pdv" autocomplete="off" value="{{ isset($pdv) ? $pdv->nombres . ' ' . $pdv->apellidos : '' }}" required>
                                                <i class="mdc-text-field__icon mdc-text-field__icon--trailing fas fa-spinner sending white-text"></i>
                                                <span id="clear-pdv" class="form-clear d-none mdc-icon-clear" style="display: none">
                                                    <i class="mdc-text-field__icon mdc-text-field__icon--trailing fas fa-times"></i>
                                                </span>
                                            </label>
                                            <div class="mdc-text-field-helper-line">
                                                <div class="mdc-text-field-helper-text mdc-text-field-helper-text--validation-msg nowrap" id="mdc-helper-pdv" aria-hidden="true"></div>
                                            </div>
                                            <div id="toolbar" class="toolbar mdc-menu-surface--anchor">
                                                <div class="mdc-menu mdc-menu-surface mdc-menu--dense" role="listbox" id="mdc-menu__buscar_pdv">
                                                    <ul class="mdc-list">
                                                        <!-- Items que coincidan con la búsqueda -->
                                                    </ul>
                                                </div>
    ...
    <script>
        ...
        const pdv = new mdc.textField.MDCTextField(document.querySelector('#mdc-pdv'));
        ...
        var ciudadExpDef = '';                 // Valor por defecto del campo de ciudad de expedición
        var copDef = '';                 // Valor por defecto del campo de ciudad
        var ciudades = @json($ciudades);    // Listado de ciudades
        var pdvs = @json($pdvs);    // Listado de pdvs
        var cop = @json($pdv);    // Listado de pdv seleccionado
        // console.log(pdv);

        @if (isset($cliente))
        {
            $('#ciudad_exp').val({{ $cliente->ciudad_exp }});
            ciudadExp.value = '{{ $cliente->ciudadExp->ciudad }}';
            ciudadExpDef = ciudadExp.value;
            $('#ciudad').val({{ $cliente->ciudad }});
            ciudad.value = '{{ $cliente->ciudadCl->ciudad }}';
            $('#mdc-ciudad input').blur();
            ciudadDef = ciudad.value;
        ...
        @if(isset($pdv))
        {
            copDef = cop.nombres + ' ' + cop.apellidos;
            $('#cop').val(cop.codigo_vendedor);
            $('#clear-cop').show();
        }
        @endif
        ...
        **/
        ...
        /**
            Acciones para Input de cop
            20/01/2021
        **/
        {
            // Busca los primeros 10 valores del listado de ciudades que concuerden con lo ingresado en el input

            $('#mdc-pdv input').keyup(function(){
                let busqueda = $(this).val().toUpperCase();
                if(busqueda){
                    $('#clear-pdv').show();
                    $('#mdc-menu__buscar_pdv').addClass('mdc-menu-surface--open');
                    $('#mdc-menu__buscar_pdv').empty();
                    if (pdvs.length) {
                        let auxCant = 0;
                        for (let index = 0; index < pdvs.length; index++) {
                            const auxPdvs = pdvs[index];
                            console.log(auxPdvs);
                            // Se configura para que no tenga en cuenta las tildes
                            if (auxPdvs.nombres.normalize("NFD").replace(/[\u0300-\u036f]/g, "").includes(busqueda.normalize("NFD").replace(/[\u0300-\u036f]/g, "")) || auxPdvs.apellidos.normalize("NFD").replace(/[\u0300-\u036f]/g, "").includes(busqueda.normalize("NFD").replace(/[\u0300-\u036f]/g, ""))) {
                                auxCant++;
                                if (auxPdvs.codigo_vendedor == $('#pdv').val()) {
                                    $('#mdc-menu__buscar_pdv').append('<li tabindex="0" class="mdc-list-item mdc-list-item--selected red-on-hover" aria-selected="true" data-index="'+ index +'" data-value="'+ auxPdvs.codigo_vendedor +'" role="option"><span class="mdc-list-item__ripple"></span><span class="mdc-list-item__text">'+ auxPdvs.nombres + ' ' + auxPdvs.apellidos +'</span></li>');
                                } else {
                                    $('#mdc-menu__buscar_pdv').append('<li tabindex="0" class="mdc-list-item red-on-hover" data-index="'+ index +'" data-value="'+ auxPdvs.codigo_vendedor +'" role="option"><span class="mdc-list-item__ripple"></span><span class="mdc-list-item__text">'+ auxPdvs.nombres + ' ' + auxPdvs.apellidos +'</span></li>');
                                }
                            }
                            if (auxCant == 10) {
                                break;
                        ...
                        if (!auxCant) {
                            $('#mdc-menu__buscar_pdv').append('<li class="mdc-list-item cursor-default" role="option"><span class="mdc-list-item__text">No Hay Resultados</span></li>');
                        }
                    } else {
                        $('#mdc-menu__buscar_pdv').append('<li class="mdc-list-item cursor-default" role="option"><span class="mdc-list-item__text">No Hay Resultados</span></li>');
                    }
            ...
            // Restablece el valor por defecto en el compo de cop al quitar el foco del campo
            $('#mdc-pdv input').blur(function() {
                if(!$('#mdc-menu__buscar_pdv').hasClass('mdc-menu-surface--open')) {
                    cop.value = copDef;
                }
                if (copDef == '' || copDef == null) {
                    $('#clear-pdv').hide();
                } else {
                    $('#clear-pdv').show();
                }
            ...
            // Configura las acciones al presionar las teclas Enter, Abajo, Arriba y Esc; mientras el foco está en el input
            $('#mdc-pdv input').keydown(function(e) {
                if (e.key === 'Enter' || e.keyCode === 13) {
                    e.preventDefault();
                    if ($('#mdc-menu__buscar_pdv').hasClass('mdc-menu-surface--open')) {
                        let index = $('#mdc-menu__buscar_pdv .mdc-list-item').first().data('index');
                        let value = $('#mdc-menu__buscar_pdv .mdc-list-item').first().data('value');
                        seleccionarCOP(index, value);
                    }
                } else if (e.key === 'Down' || e.keyCode === 40) {
                    e.preventDefault();
                    if ($('#mdc-menu__buscar_pdv').hasClass('mdc-menu-surface--open')) {
                        ...
                        let value = $('#mdc-menu__buscar_pdv .mdc-list-item').first().data('value');
                        if (index != undefined || index != null) {
                            $('#mdc-menu__buscar_pdv .mdc-list-item').first().focus();
                        }
                    }
                } else if (e.key === 'Up' || e.keyCode === 38) {
                    e.preventDefault();
                    if ($('#mdc-menu__buscar_pdv').hasClass('mdc-menu-surface--open')) {
                        let index = $('#mdc-menu__buscar_pdv .mdc-list-item').last().data('index');
                        let value = $('#mdc-menu__buscar_pdv .mdc-list-item').last().data('value');
                        if (index != undefined || index != null) {
                            $('#mdc-menu__buscar_pdv .mdc-list-item').last().focus();
                        }
                    }
                } else if (e.key === 'Escape' || e.key === 'Esc' || e.keyCode === 27) {
                    e.preventDefault();
                    cop.value = copDef;
                    $('#mdc-pdv input').blur();
                    $('#mdc-menu__buscar_pdv').removeClass('mdc-menu-surface--open');
                    if (copDef == '' || copDef == null) {
                        $('#clear-pdv').hide();
                    } else {
                        $('#clear-pdv').show();
            ...
            // Selecciona el cop en el cual se hace click
            $('#mdc-menu__buscar_pdv').on('click', '.mdc-list-item', function() {
                let value = $(this).data('value');
                let index = $(this).data('index');
                seleccionarCOP(index, value);
            });

            // Selecciona el primer cop de la lista, en caso de que se oprima Enter mientras el foco está en el input
            $('#mdc-menu__buscar_pdv').on('keydown', '.mdc-list-item', function(e) {
                if (e.key === 'Enter' || e.keyCode === 13) {
                    e.preventDefault();
                    let value = $(this).data('value');
                    let index = $(this).data('index');
            ...
            // Limpia el campo del cop, pero no altera el campo por defecto
            $('#clear-pdv').click(function() {
                cop.value = '';
                cop.valid = true;
                $(this).hide();
                $('#mdc-pdv input').focus();
            ...
            // Selecciona la ciudad con base en el index del listado y el id
            function seleccionarCOP(index, value) {
                if (index === undefined || index === null) {
                    cop.value = copDef;
                } else {
                    let auxPdvs = pdvs[index];
                    copDef = auxPdvs.nombres + ' ' + auxPdvs.apellidos;
                    $('#cop').val(value);
                    pdv.value = copDef;
                }
                $('#mdc-cop input').blur();
        ...
        **/
        ...
        @elseif (Session::has('cliente_actualizado'))
            ...
            Swal.fire({
                ...
                text: 'El cliente con cc/nit ' + dataSession.cc_nit + ' y nombre ' + dataSession.nombre_cliente + ' se ha actualizado exitosamente.',
                icon: 'success'
            });
            @php
